...
#if DEBUG
var baseadd = "https://localhost:7289/";
#else
    var baseadd = "https://papiamentoforai.azurewebsites.net";
#endif
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Language Improver For AI API V1");
});
