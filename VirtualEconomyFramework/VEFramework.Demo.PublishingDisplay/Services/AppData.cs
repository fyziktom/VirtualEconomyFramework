...
namespace VEFramework.Demo.PublishingDisplay.Services
{
    public class AppData
    {
        ...
        public static string AppShareNFTUrl { get; set; } = "https://localhost:7055/";//"https://publishing.ve-nft.com/";        
        ...
        public IEnumerable<INFT> RandProfilesNFTs
        {
            get => NFTs.Where(n => n.Type == NFTTypes.CoruzantProfile).OrderBy(n => rnd.Next());
        }
