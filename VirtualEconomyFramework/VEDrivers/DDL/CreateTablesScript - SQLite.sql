...
insert into "Keys" ("Id", "Name", "StoredKey". "RelatedItemId",  "PasswordHash", "IsEncrypted", "Type", "CreatedBy", "CreatedOn", "ModifiedBy", "ModifiedOn", "Version") values
('0aa38ea1-08bd-43lc-b457-0bfb18234fac', 'TestKey' ,'fc5df2f1-6def-4f08-973b-d9584e85b4d2', '', '', false, 1, 'fyziktom', datetime(),'fyziktom', datetime(), '0.1'),
('4fl49487-f544-aadf-a544-7c32afa53fbc', 'MainAccountKey', '851e5874-1824-4fa9-bba6-7c4fc007aea5', '', '', false, 1, 'fyziktom', datetime(),'fyziktom', datetime(), '0.1');
