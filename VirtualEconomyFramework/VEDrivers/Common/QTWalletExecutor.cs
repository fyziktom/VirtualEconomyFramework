...
{
    public class QTWalletExcecutorConfig
    {
    ...
    public class QTWalletExecutor : IHostedService
    {
        ...
        public QTWalletExecutor(IConfiguration settings, IHostApplicationLifetime lifetime)
        {
            var config = settings.GetSection("QTWalletExecutor").Get<QTWalletExcecutorConfig>();
            if (config == null)
            {
