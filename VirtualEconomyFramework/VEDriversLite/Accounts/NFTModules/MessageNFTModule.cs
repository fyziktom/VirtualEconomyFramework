...
{
    public class MessageNFTModule : CommonNFTModule
    {
        public MessageNFTModule()
        {
            TokenId = NFTHelpers.TokenId;
            Type = NFTModuleType.Messages;
        }
        ...
        public override async Task ReLoadNFTs(ReloadNFTSetting settings)
        {
            if (settings.FirstLoad)
                base.FirstLoadNFTsChanged += MessageNFTModule_FirstLoadNFTsChanged;
            else
                base.NFTsChanged += MessageNFTModule_NFTsChanged;
        ...
        private void MessageNFTModule_NFTsChanged(object sender, string e)
        {
            NFTsChanged?.Invoke(sender, e);
        }

        private void MessageNFTModule_FirstLoadNFTsChanged(object sender, INFT e)
        {
