...
{
    /// <summary>
    /// FW Src NFT - represents the source plans/code of some firmware
    /// </summary>
    public class FWSrcNFT : CommonNFT
    {
        /// <summary>
        /// Constructor of the empty NFT FWSrc
        /// </summary>
        /// <param name="utxo"></param>
        public FWSrcNFT(string utxo)
        {
            Utxo = utxo;
            Type = NFTTypes.FWSrc;
            TypeText = "NFT FWSrc";
