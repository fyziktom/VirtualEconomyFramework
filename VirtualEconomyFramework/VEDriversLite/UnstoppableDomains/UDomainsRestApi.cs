...
namespace VEDriversLite.UnstoppableDomains
{
    ...
    {
        private string _baseUrl = "https://unstoppabledomains.com/api/v1/";
        ...
        public System.Threading.Tasks.Task<GetAddressDetailsResponse> GetAddressDetailsAsync(string address)
        {
            return GetAddressDetailsAsync(address, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Object containing doge balance, if address symbol does not exist on network, empty object is returned.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<GetAddressDetailsResponse> GetAddressDetailsAsync(string address, System.Threading.CancellationToken cancellationToken)
        {
            if (address == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetAddressDetailsResponse>(response_, headers_).ConfigureAwait(false);
    ...
    public partial class GetAddressDetailsResponse
    {
        ...
        /// <summary>Success flag</summary>
        [Newtonsoft.Json.JsonProperty("ipfs", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public IDictionary<string, string> IPFS { get; set; }
        /// <summary>Success flag</summary>
        ...
        public IDictionary<string, string> Records { get; set; }
        /// <summary>Success flag</summary>
        ...
        /// <summary>Success flag</summary>
        [Newtonsoft.Json.JsonProperty("multicoinAddresses", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public IDictionary<string, string> MultiCoinAddresses { get; set; }

        /// <summary>Success flag</summary>
        [Newtonsoft.Json.JsonProperty("whois", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public IDictionary<string, string> WhoIs { get; set; }
